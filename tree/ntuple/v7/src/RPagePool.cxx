...
void ROOT::Experimental::Internal::RPagePool::RegisterPage(
   const Detail::RPage &page, const Detail::RPageDeleter &deleter)
{
...
void ROOT::Experimental::Internal::RPagePool::PreloadPage(
   const Detail::RPage &page, const Detail::RPageDeleter &deleter)
{
   std::lock_guard<std::mutex> lockGuard(fLock);
   fPages.emplace_back(page);
...
ROOT::Experimental::Detail::RPage ROOT::Experimental::Internal::RPagePool::GetPage(
