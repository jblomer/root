...
void ROOT_ntpl_entry_reset(ROOT_ntpl *ntpl);
bool ROOT_ntpl_collection_next(ROOT_ntpl_view *view);
void ROOT_ntpl_collection_reset(ROOT_ntpl_view *view);

ROOT_ntpl_view *ROOT_ntpl_view(void *ntpl_or_view, const char *field);
...
ROOT_ntpl_view *pt           = ROOT_ntpl_view(ntpl,   "pt");
ROOT_ntpl_view *tracks       = ROOT_ntpl_view(ntpl,   "tracks");
ROOT_ntpl_view *track_energy = ROOT_ntpl_view(tracks, "E"); // accesses tracks.E
