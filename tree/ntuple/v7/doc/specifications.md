...
All secondary column representations have the same number of columns and the same column cardinality
than the primary column representation.
That means that the absolute values of the element offset of primary and secondary representations are identical.
